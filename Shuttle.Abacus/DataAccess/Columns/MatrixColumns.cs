...
namespace Shuttle.Abacus.DataAccess
{
    public class MatrixColumns
    {
        ...
        public static readonly MappedColumn<string> RowArgumentName =
            new MappedColumn<string>("RowArgumentName", DbType.AnsiString);

        public static readonly MappedColumn<string> ColumnArgumentName =
            new MappedColumn<string>("ColumnArgumentName", DbType.AnsiString);

        public static readonly MappedColumn<string>
            ValueType = new MappedColumn<string>("ValueType", DbType.AnsiString);
